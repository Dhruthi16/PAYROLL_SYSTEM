...
const (
	PayrollService_CreatePayroll_FullMethodName = "/payroll.PayrollService/CreatePayroll"
	PayrollService_GetPayroll_FullMethodName    = "/payroll.PayrollService/GetPayroll"
	PayrollService_UpdatePayroll_FullMethodName = "/payroll.PayrollService/UpdatePayroll"
	PayrollService_DeletePayroll_FullMethodName = "/payroll.PayrollService/DeletePayroll"
	PayrollService_ListPayrolls_FullMethodName  = "/payroll.PayrollService/ListPayrolls"
)
...
type PayrollServiceClient interface {
	CreatePayroll(ctx context.Context, in *CreatePayrollRequest, opts ...grpc.CallOption) (*Payroll, error)
	GetPayroll(ctx context.Context, in *GetPayrollRequest, opts ...grpc.CallOption) (*Payroll, error)
	UpdatePayroll(ctx context.Context, in *UpdatePayrollRequest, opts ...grpc.CallOption) (*Payroll, error)
...
func (c *payrollServiceClient) CreatePayroll(ctx context.Context, in *CreatePayrollRequest, opts ...grpc.CallOption) (*Payroll, error) {
...
func (c *payrollServiceClient) GetPayroll(ctx context.Context, in *GetPayrollRequest, opts ...grpc.CallOption) (*Payroll, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payroll)
...
func (c *payrollServiceClient) UpdatePayroll(ctx context.Context, in *UpdatePayrollRequest, opts ...grpc.CallOption) (*Payroll, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payroll)
...
type PayrollServiceServer interface {
	CreatePayroll(context.Context, *CreatePayrollRequest) (*Payroll, error)
	GetPayroll(context.Context, *GetPayrollRequest) (*Payroll, error)
	UpdatePayroll(context.Context, *UpdatePayrollRequest) (*Payroll, error)
...
func (UnimplementedPayrollServiceServer) CreatePayroll(context.Context, *CreatePayrollRequest) (*Payroll, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePayroll not implemented")
}
func (UnimplementedPayrollServiceServer) GetPayroll(context.Context, *GetPayrollRequest) (*Payroll, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPayroll not implemented")
}
func (UnimplementedPayrollServiceServer) UpdatePayroll(context.Context, *UpdatePayrollRequest) (*Payroll, error) {
...
var PayrollService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payroll.PayrollService",
